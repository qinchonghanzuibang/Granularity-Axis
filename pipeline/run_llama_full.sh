#!/bin/bash
#
# One-click full pipeline for Llama-3.1-8B-Instruct.
...
#
# Common overrides:
#   MODEL=/path/to/Llama-3.1-8B-Instruct bash pipeline/run_llama_full.sh
#   OUTPUT_DIR=outputs/llama31 bash pipeline/run_llama_full.sh
#   TENSOR_PARALLEL_SIZE=2 bash pipeline/run_llama_full.sh
#   JUDGE_MODELS="gpt-4.1-mini" OPENAI_API_KEY=... bash pipeline/run_llama_full.sh
#
...
# ================= Configuration =================
MODEL="${MODEL:-/mnt/dhwfile/raise/user/qinchonghan/models/Llama-3.1-8B-Instruct}"
...
echo "============================================================"
echo "  Full Flow (Llama): Granularity Axis"
echo "  Model:      $MODEL"
...
########################################################################
# Supplementary: representation + subgroups
########################################################################
echo ""
...
########################################################################
# Supplementary: steering sweeps + evaluation
########################################################################
echo ""
...
########################################################################
# Score filtering ablation (optional)
########################################################################
